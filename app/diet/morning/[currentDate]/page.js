...
import MorningFood from "../morningfood";
    ...
    <div className="daily-record">
      <div className="record-left">
        ...
        <form action="/api/diet/new" method="POST">
          <input name="time1" defaultValue="아침" style={{ display : "none" }}/>
          ...
          <input name="food" placeholder="음식" type="text"/>
      ...
      <MorningFood currentDate={currentDate}/>
    </div>
    </>
  )
}